...
case class ShipState(mainEngineThrust:Float, rotationalEngineThrust:Float, strafeEngineThrust:Float, shipForeLength:Float, shipAftLength:Float, imgPath:String)
